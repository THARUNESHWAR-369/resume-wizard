...
/* Get Password object */
export function passwordObject(validateCallBack: IValidateCallback, btnDisabledState = true) {
  const inputFiledID = "password";
  return (
    <div className="password-object w-full h-full p-4">
      <div className="password-object-cont">
        <h3 className="font-normal">set your password?</h3>
        ...
        <div className="object-button pb-2 pt-3 float-right">
          <button
            ...
            className={`border-[2px] rounded-md px-2 py-1 font-bold cursor-pointer  transition-all duration-300 ${
              btnDisabledState
                ? "bg-gray-500 border-gray-500 text-white cursor-not-allowed"
                : "border-foreground-accent-color-3  text-foreground-accent-color-3 hover:border-foreground-accent-color-2 hover:bg-foreground-accent-color-2 hover:text-white"
            }`}
          >
            SignUp
          </button>
