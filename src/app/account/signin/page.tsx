  ...
  return (
    <section className="mb-0">
      ...
      <main className="w-full h-full max-w-[68em] m-auto max-md:max-w-full">
        <section className="accounts-signin  w-full max-sm:sm:p-0 mb-2">
          <div className="accounts-signin-container p-[1em] max-md:md:p-0">
            <div className="max-w-[33em] bg-white m-auto box-shadow-1 rounded-md p-[1em] md:max-md:w-[90%]">
              <span className="title-gradient text-4xl text-center w-full block py-3 font-bold">
                Welcome Back
              </span>
              <div className="form-group py-3 flex flex-col gap-3">
                <div className="accounts-form-group">
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      id="username"
                      required
                      className="rounded-none outline-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-foreground-accent-color-2 focus:border-foreground-accent-color-2 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-foreground-accent-color-2 dark:focus:border-foreground-accent-color-2"
                ...
                <button
                  type="submit"
                  className="mt-3 border-none box-shadow-1 outline-none bg-foreground-accent-color-3 w-full h-[2.5em] text-white hover:bg-foreground-accent-color-2/90 font-bold rounded-md"
                >
                  Login
                </button>
                ...
                <a
                  ...
                  className="font-semibold underline text-foreground-accent-color-4 text-right hover:cursor-pointer hover:text-foreground-accent-color-3"
                >
                  New User?
                </a>
